            ...
            <table id="residentsTable">
                ...
                <tbody>
                    ...
                    <tr id="residentNoResults" style="<?php echo $has_rows ? 'display: none;' : ''; ?>">
                        <td colspan="8" style="text-align:center; padding: 40px; color: var(--text-gray);">No residents found matching your criteria.</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="panel modal-container" style="width:450px; max-width:90%; border-radius:24px; padding:32px;">
        ...
        <form action="add_members.php" method="GET">
            ...
            <div style="display:flex; justify-content:flex-end; gap:12px;">
                ...
                <button type="submit" style="padding:12px 28px; border:none; background:#2563eb; color:white; border-radius:12px; cursor:pointer; font-weight:700; font-size:14px;">Next Step</button>
            </div>
        </form>
    </div>
</div>
